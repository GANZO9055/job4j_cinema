...
class Sql2oUserRepositoryTest {
    ...
    public void whenSaveUserThenGetUser() {
        var user = sql2oUserRepository.save(new User("test1", "test@gmail.com", "test123"));
    ...
    public void whenSaveTwoUsersThenGetError() {
        var user1 = sql2oUserRepository.save(new User("test1", "test@gmail.com", "test123"));
        var user2 = sql2oUserRepository.save(new User("test1", "test@gmail.com", "test123"));
